...
import { FaTools, FaCalendarCheck, FaExclamationTriangle, FaHistory } from 'react-icons/fa';
  ...
  return (
    <div style={sidebarStyle}>
      ...
      <Link 
        ...
        onMouseEnter={e => e.currentTarget.style.backgroundColor = '#f1f1f1'}
        onMouseLeave={e => {
          if (location.pathname !== '/maintenance') e.currentTarget.style.backgroundColor = 'transparent';
        }}
      >
      ...
      <Link 
        ...
        onMouseEnter={e => e.currentTarget.style.backgroundColor = '#f1f1f1'}
        onMouseLeave={e => {
          if (location.pathname !== '/incidents') e.currentTarget.style.backgroundColor = 'transparent';
        }}
      >
      ...
      <Link 
        ...
        onMouseEnter={e => e.currentTarget.style.backgroundColor = '#f1f1f1'}
        onMouseLeave={e => {
          if (location.pathname !== '/repair-history') e.currentTarget.style.backgroundColor = 'transparent';
        }}
      >
