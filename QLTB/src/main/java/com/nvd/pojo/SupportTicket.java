...
@NamedQueries({
    ...
    @NamedQuery(name = "SupportTicket.findByStatus", query = "SELECT s FROM SupportTicket s WHERE s.status = :status"),
...
public class SupportTicket implements Serializable {
    ...
    public SupportTicket(Long id, String issue, String status, Date timestamp) {
        this.id = id;
        this.issue = issue;
        this.status = status;
