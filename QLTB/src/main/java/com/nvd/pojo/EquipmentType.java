...
@NamedQueries({
    ...
    @NamedQuery(name = "EquipmentType.findByName", query = "SELECT e FROM EquipmentType e WHERE e.name = :name")})
public class EquipmentType implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        EquipmentType other = (EquipmentType) object;
    ...
    public String toString() {
        return "com.nvd.pojo.EquipmentType[ id=" + id + " ]";
    }
